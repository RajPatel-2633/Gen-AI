...
available_tools = {
    ...
    "run_command":{
        "fn":run_command,
        "description":"Takes a commmand as an input to execute on system and returns output"
    }
}
...
system_prompt = f'''
  ...
  - run_command: Takes a commmand as an input to execute on system and returns output
